...
public class FrmLogin extends javax.swing.JFrame {
   ...
   private Empleado empleado;
    ...
    /**
        * Recibe como parametro el ID de trabajo obtenidad de la Base de datos y verifica si es Aministrador (1)
        * o un empleado (0) para activar una determinada ventana
        * @author Grupo E
    */
